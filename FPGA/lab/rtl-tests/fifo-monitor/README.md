...
contract. Almost-full and configured-capacity observations remain extended
event sources but do not assert legacy bit 31. V27 tied that legacy source
low; V30 now preserves the same host-visible boundary. Legacy bits 29--30 use
the V27 read-to-clear boundary.
