...
All notable changes from the hardened app convergence pass are documented here.
...
- The hardened source tree, helper scripts, and compatibility checklist are
  now carried directly by `P2_app` instead of remaining staged only under
  `P3_app`.
- The temporary `p3app` compatibility symlink target has been retired from the
  app Makefiles as part of the source-tree cutover.
- The hidden Saturn service lab now treats `P2_app` as the single supported
  build/deploy source while still accepting legacy `p3` action arguments as
  compatibility aliases.
- The April 7, 2026 restart/reconnect validation pass is treated as the gate
  that allowed this cutover work to proceed.

### Verified

- `make -C /home/pi/github/Saturn/sw_projects/P2_app clean && make -C /home/pi/github/Saturn/sw_projects/P2_app -j1`
- `make -C /home/pi/github/Saturn/sw_projects/P3_app clean && make -C /home/pi/github/Saturn/sw_projects/P3_app -j1`
