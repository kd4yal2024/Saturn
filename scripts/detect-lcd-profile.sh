...
Environment:
  ...
  SATURN_FRONT_PANEL_TYPE=G2V1|G2V2|RemoteHead|NONE  (tiebreaker: G2V1/G2V2 on 7-inch → g2-single-dsi; RemoteHead is recorded but does not change LCD profile)
...
main() {
  ...
  local emit_config=0
  local boot_config=""
  local profile_raw profile size source cm
