...
Current merged firmware policy (2026-09-20): primary PCB2 firmware 1.27–1.30
may key RF when `SATURN_REMOTE_TX_RF_ENABLED=1`, retaining the existing
interlocks. This preserves main's firmware permission range; it does not
establish V28/V29/V30 hardware TX qualification. The operator confirmed a
dummy load and amplifier isolation for the requested V30 enablement. The
first transmit and power/SWR/FIFO checks remain supervised operator actions.

Earlier integration policy and test history: V29 alone receives its
