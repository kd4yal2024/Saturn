...
| Hidden P2/P3 workload/performance dashboard | `p23test.html` (hidden/no nav link) | `GET /p23_perf` | Host process/network/XDMA sampling plus `/dev/shm/saturn_p23_perf_stats.json` app telemetry overlay | N/A |
