...
struct SettingsBackupSources {
    ...
    performance_benchmarks_file: PathBuf,
...
impl SettingsBackupSources {
    fn from_state(state: &AppState) -> Result<Self, String> {
        ...
        Ok(Self {
            ...
            performance_benchmarks_file: state_root.join("performance_benchmarks.json"),
...
fn build_settings_backup_tree(
    ...
    let result = (|| {
        ...
        let state_files = [
            ...
            (
                &sources.performance_benchmarks_file,
...
mod tests {
    ...
    fn settings_tree_contains_only_declared_portable_files() {
        ...
        let sources = SettingsBackupSources {
            ...
            performance_benchmarks_file: missing.join("performance_benchmarks.json"),
