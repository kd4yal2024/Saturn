import { cleanupNormalized } from './dsp/display-cleanup';
...
import {
  ...
  txPowerToAuxDeg,
  swrToAuxDeg,
  normalizeInstrumentMeterMode,
  instrumentMeterDegrees,
  SM_CX,
  SM_CY,
  SM_R,
  SM_START,
...
const api = {
  SpectrumHistory, TerrainRenderer, cleanupNormalized, normalizeTerrain, referenceColor, fitTerrainRange,
  // Controller / runtime
  ...
  normalizeInstrumentMeterMode, instrumentMeterDegrees,
